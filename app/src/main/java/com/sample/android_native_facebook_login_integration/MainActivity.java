package com.sample.android_native_facebook_login_integration;
...
import com.sample.android_native_facebook_login_integration.javasample.JavaFacebookSignInActivity;
import com.sample.android_native_facebook_login_integration.kotlinsample.KotlinFacebookSignInActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cvJava.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(MainActivity.this, JavaFacebookSignInActivity.class);
        ...
        cvKotlin.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(MainActivity.this, KotlinFacebookSignInActivity.class);
                startActivity(intent);
            }
        });
    }
